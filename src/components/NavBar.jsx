...
const NavBar = () => {
  return (
    <div className="w-full h-min flex justify-center items-center sticky top-0">
      <div className="w-[98%] h-[70px] flex justify-between items-center mt-[25px] bg-darkPurple/[.15] rounded-[35px] hover:bg-darkPurple/[.8] ease-in-out duration-300">
        <div className="w-min h-min flex justify-center items-center gap-5">
          <Logo />
          <Social />
        </div>
        <div className="w-min h-min flex justify-center items-center gap-5">
          <div className="flex items-center mr-2 space-x-[20px] text-[12px] font-[400] tracking-[5px] uppercase">
